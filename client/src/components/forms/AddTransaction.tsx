              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                    ...
                    <SelectContent>
                      <SelectItem value="need">Kebutuhan (Needs) - Wajib</SelectItem>
                      <SelectItem value="want">Keinginan (Wants) - Opsional</SelectItem>
                      <SelectItem value="savings">Tabungan/Investasi</SelectItem>
                    </SelectContent>
                  </Select>
                  <FormMessage />
                </FormItem>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Contoh: Makan Siang, Kopi, Gaji" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
